...
#     # Streamlit Drawing Canvas (using `streamlit-drawable-canvas` package)
#     st.write("**Draw a digit below:** (Make sure the canvas is square and clean before drawing)")
...
#             # Display the raw canvas image
#             st.image(canvas.image_data, caption="Canvas Input", width=140)
...
#             st.write(f"PCA-transformed data shape: {processed_image_pca.shape}")
